...
<div x-data="{
    ...
    x-on:mouseenter="onMouseEnter()" x-on:mouseleave="onMouseLeave()">
    <div class="flex items-center">
        ...
        <div class="ml-3 flex-1 w-0">
            <p x-text="toast.content" class="text-sm font-medium leading-5 text-gray-900 dark:text-white break-words">
            </p>
        </div>

        <!-- Close Button -->
        <div class="ml-4 flex " x-on:click="dismiss()">
            <button type="button"
