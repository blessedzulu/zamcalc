<div class="relative z-10 w-full">
    ...
    <div class="grid grid-cols-5">
        ...
        <div
            class="border-neutral-600/30 bg-background z-40 col-span-3 border !border-t-0 border-dashed py-10 lg:py-20">
        </div>
        <div class="border-neutral-600/30 border !border-l-0 !border-r-0 !border-t-0 border-dashed py-6"
    ...
    <div class="grid grid-cols-5">
        ...
        <div
            ...
            <h1
                class="text-base-100 mx-auto px-4 text-3xl font-bold tracking-tight text-center sm:text-5xl md:max-w-lg md:px-0">
    ...
    <div class="grid grid-cols-5">
        ...
        <div
            ...
            <x-ui.text class="opacity-50 mx-auto max-w-2xl px-4 text-center sm:text-lg md:px-0">
                Sheaf UI is a CLI-driven UI framework that scaffolds elegant Blade + Livewire components right into your
                codebase. It’s open source, production-ready, and fully yours.
            </x-ui.text>
        </div>
    ...
    <div class="grid grid-cols-5">
        ...
        <div
            ...
            <x-ui.button href="https://sheafui.dev/docs/guides/overview" iconAfter="arrow-up-right" target="_blank">
                Get started
            </x-ui.button>
        </div>
