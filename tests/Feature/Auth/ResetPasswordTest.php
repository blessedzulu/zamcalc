...
test('reset password can be requested', function () {
    ...
    livewire(ForgotPassword::class)->set('email', $user->email)->call('sendPasswordResetLink');
...
test('reset password screencan be rendered', function () {
    ...
    Notification::assertSentTo(
        ...
        callback: function (ResetPassword $notification) {
            get('/reset-password/' . $notification->token)->assertSee('Reset your password')->assertOk(); // just for making sure that we're in the reset password page
